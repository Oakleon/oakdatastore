...
let _project_id    = process.env.GCLOUD_PROJECT   || read_project_id_from_file(__dirname + '/auth-project');
...
function read_project_id_from_file(filename) {
    ...
    if (!_Fs.existsSync(filename)) {
        console.error('a project id is required, try setting the GCLOUD_PROJECT environment variable');
        process.exit(99);
    }
